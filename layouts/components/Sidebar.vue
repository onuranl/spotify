<template>
  <div class="sidebar">
    <div class="sidebar_content">
      <div class="sidebar_content-logo">
        <nuxt-link to="/">
          <!-- <img src="~/assets/images/logo.png" alt="" /> -->
          <svg class="sidebar_content-logo-content" viewBox="0 0 1134 340">
            <title>Spotify</title>
            <path
              fill="currentColor"
      ...
      <div class="sidebar_content-menu">
        <ul>
          <li>
            <nuxt-link
              to="/"
              class="sidebar_content-menu-item"
              :class="
                $route.fullPath == '/' ? 'sidebar_content-menu-item-active' : ''
              "
            >
              <svg
                v-if="$route.fullPath !== '/'"
              ...
              <svg v-else role="img" height="24" width="24" viewBox="0 0 24 24">
            ...
            <nuxt-link
              ...
              :class="
                $route.fullPath == '/search'
                  ? 'sidebar_content-menu-item-active'
                  : ''
              "
            >
              <svg
          ...
          <li>
            <nuxt-link
              ...
              class="sidebar_content-menu-item"
              :class="
                $route.fullPath == '/collection/playlists' ||
                $route.fullPath == '/collection/podcasts' ||
                $route.fullPath == '/collection/artists' ||
                $route.fullPath == '/collection/albums'
                  ? 'sidebar_content-menu-item-active'
                  : ''
              "
            >
      ...
      <div class="sidebar_content-rootlist">
        <div class="sidebar_content-rootlist-container">
          <div class="sidebar_content-rootlist-container-create-playlist">
            <button
              class="sidebar_content-rootlist-container-create-playlist-button"
            >
              <div
                class="sidebar_content-rootlist-container-create-playlist-button-icon"
              >
                <div
                  class="sidebar_content-rootlist-container-create-playlist-button-icon-content"
                >
                  <svg
                    role="img"
                    height="12"
          ...
          <div
            class="sidebar_content-rootlist-container-tracks"
            :class="
              $route.fullPath == '/collection/tracks'
                ? 'sidebar_content-rootlist-container-tracks-active'
                : ''
            "
          >
            <nuxt-link to="/collection/tracks" draggable="false">
              <div class="sidebar_content-rootlist-container-tracks-icon">
                <div
                  class="sidebar_content-rootlist-container-tracks-icon-content"
                >
                  <svg
                    role="img"
                    height="12"
